...
import 'package:appsaude/contagem_passos.dart';
import 'package:appsaude/contato.dart';
import 'package:appsaude/screens/agendamento/agendamento_hub_screen.dart';
import 'package:appsaude/screens/agendamento/agendamento_screen.dart';
// import 'package:appsaude/screens/login_screen.dart';
import 'package:appsaude/screens/perfil.dart';
import 'package:appsaude/widgets/box_option.dart';
...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 47, 154, 255),
        elevation: 0,
        toolbarHeight: 60,
        title: Center(
          child: Text(
                  ...
                  IconButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (_, __, ___) => ContagemPassosPage(),
                          transitionDuration: Duration(milliseconds: 200),
                          transitionsBuilder: (_, a, __, c) =>
                              FadeTransition(opacity: a, child: c),
                        ),
